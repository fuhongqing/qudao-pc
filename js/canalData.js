$(function(){
    ...
    $('header').on('click','a',function(e){
        ...
        if($(e.target).html()=='渠道信息'){
            $(location).attr('href','canalDetail.html');
        }
    });
    //绘制日折线图
    function date(){
            ...
            series : [
                {
                    ...
                    //设置折线线条颜色
                    symbol:'circle',//拐点样式none ,emptycircle：空心圆；emptyrect：空心矩形；circle：实心圆；emptydiamond：菱形
                    symbolSize: 8,//拐点大小
                    itemStyle : {
                        normal : {
                            color:"#7BB3ED",
